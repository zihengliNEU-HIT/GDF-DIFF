    ...
    for file_name in os.listdir(data_dir):
        if pattern in file_name:
            ...
            if '53C_54' in file_name:
                battery_type_str = '53C_54'
            elif '56C_19' in file_name:
                battery_type_str = '56C_19'
            elif '56C_36' in file_name:
                battery_type_str = '56C_36'
            else:
...
def create_model(args):
    ...
    network = UNet(
        ...
        channel_mults=(1, 2, 4),
        time_emb_dim=128,
        condition_emb_dim=64, #LFP=64
        use_attention=(False, False, True),
        num_res_blocks=2,
        cond_vector_dim=23 #LFP=23
    ).to(args.device)
...
def main(args=None):
    ...
    if checkpoint_path is None:
        best_model_path = os.path.join(args.checkpoint_dir, "model_epoch_60.pt")
